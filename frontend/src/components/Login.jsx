        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="max-w-md w-full rounded-[2rem] p-10 transform transition-all duration-500 glass">
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-4xl font-extrabold text-slate-900 mb-2">Trackify</h2>
                    <p className="text-slate-900/80 font-semibold">Welcome back! Log in to continue.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="group">
                        ...
                        <input
                            ...
                            className="w-full px-5 py-3.5 rounded-xl border border-slate-200 focus:ring-4 focus:ring-brand/20 focus:border-brand outline-none transition-all bg-slate-50 shadow-sm text-slate-900 placeholder-white/50 group-hover:bg-white/20"
                            value={email}
                    ...
                    <button
                        type="submit"
                        className="w-full py-3.5 px-4 bg-indigo-600 hover:bg-indigo-600-dark overflow-hidden relative text-slate-900 rounded-xl font-bold shadow-[0_8px_30px_rgb(59,130,246,0.3)] transform transition-all duration-300 hover:-translate-y-1 active:scale-95 group"
                    >
